              ...
              <div className="d-flex justify-content-start">
                ...
                <div className="d-flex flex-column ml-1">
                  <div className="user-info mb-1">
                    ...
                    <CardText tag="span">{selectedUser !== null ? selectedUser.email : "eleanor.aguilar@gmail.com"}</CardText>
                  </div>
          ...
          <Col xl="6" lg="12" className="mt-2 mt-xl-0">
            <div className="user-info-wrapper">
              <div className="d-flex flex-wrap align-items-center">
                ...
                <CardText className="mb-0">{selectedUser !== null ? selectedUser.username : "eleanor.aguilar"}</CardText>
              </div>
              <div className="d-flex flex-wrap align-items-center my-50">
                ...
                <CardText className="text-capitalize mb-0">{selectedUser !== null ? selectedUser.status : "Active"}</CardText>
              </div>
              <div className="d-flex flex-wrap align-items-center my-50">
                <div className="user-info-title">
                ...
                <CardText className="text-capitalize mb-0">{selectedUser !== null ? selectedUser.role : "Admin"}</CardText>
              </div>
              <div className="d-flex flex-wrap align-items-center my-50">
                <div className="user-info-title">
